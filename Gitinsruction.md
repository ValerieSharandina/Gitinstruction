...
cd SCV_Git_1804.git
```
* Начиная работу над проектом обязательно создаем новую ветку! И все изменения которые мы хотим добавить пишем именно в ней. Чтобы добавить новую ветку в проект нажимем на эту иконку:

![иконка вилки]()
Переходим в меню на команду "Создать ветвь..." Вот так:
![новая ветвь]()
Даем ей название и проверяем находимся ли мы на новой ветке. После этого создаем новый файл в которо будем работать или копируем в нее уже готовые файлы. 
...
Если нам надо связаться с каким-нибудь удалённым проектом и забирать из него все те данные проекта, которых у вас ещё нет, в терминале вводим команду:
```
